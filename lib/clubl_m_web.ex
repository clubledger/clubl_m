defmodule ClubLMWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ClubLMWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/clubl_m_web/templates",
        namespace: ClubLMWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {ClubLMWeb.LayoutView, "live.html"}
